...
class HomestuckDoll extends HatchableDoll {
    ...
    final int maxBody = 307;
    final int maxHair = 240;
    final int maxEye = 176;
    final int maxMouth = 169;
    final int maxSymbol = 250;
    final int maxGlass = 135;
    final int maxGlass2 = 152;
    final int maxFacePaint = 148;
